...
for img in test_images:
    ...
    hog_features, hog_image = extract_hog_features(image)
    # Append HOG features to the features list
    test_images_nor.append(hog_features)
...
model=KMeans(n_clusters=3,n_init=8,random_state=30)
model.fit(X_train)
...
#print(normalized__images)
print(len(normalized__images))
print('###############labels of features#################')
print(len((labels)))
#print(labels)

print('###############Features for testing were extracted#################')
#print(normalized__images)
print(len(test_images_nor))
print('###############labels for testing of features#################')
